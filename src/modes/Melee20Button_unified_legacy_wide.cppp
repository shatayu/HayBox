        ...
        */
        ...
        if (directions.diagonal /*&& !shield_button_pressed*/) {
            if (!inputs.b) {
                ...
                // 7000 3625 - 27.38deg - 56 29 - modX + cLeft
                // 6625 4125 - 31.91deg - 53 33 - modX
                ...
                // 9125 3875 - 23.09deg - 73 31 - modX + B + cDown
                // 8750 4500 - 27.22deg - 70 36 - modX + B + cLeft
                // 8500 5250 - 31.70deg - 68 42 - modX + B
        ...
        */
        ...
        if (directions.diagonal /*&& !shield_button_pressed*/) {
            if (!inputs.b) {
                ...
                // 3625 7000 - 27.38deg - 29 56 - modY + cLeft
                // 4375 7000 - 32.01deg - 35 56 - modY
                ...
                /* Extended Up B Angles */
                // 3875 9125 - 23.01deg - 31 73 - modY + B + cDown
                // 4625 8750 - 27.86deg - 37 70 - modY + B + cLeft
                // 5250 8500 - 31.70deg - 42 68 - modY + B
